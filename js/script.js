$(document).ready(function () {
    ...
    $('form').submit(function(e) {
        ...
        if (!$(this).valid()) { //если форма не прошла валидацию, то ничего не произойдет
            return;
        }
        ...
        $.ajax({
            ...
            $('.modal_mini, #thanks').fadeIn('slow');

            $('form').trigger('reset'); //все формы должны обновиться (очиститься)
        });
        return false;
    });
});